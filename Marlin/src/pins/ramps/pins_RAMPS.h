...
// Steppers
//
#define X_STEP_PIN                            36  // (A0)
#define X_DIR_PIN                             34  // (A1)
#define X_ENABLE_PIN                          30
#ifndef X_CS_PIN
  #define X_CS_PIN                       AUX3_06
#endif

#define X2_STEP_PIN                            26  // (A0)
#define X2_DIR_PIN                             28  // (A1)
...
#define Y_STEP_PIN                            AUX2_07
#define Y_DIR_PIN                             AUX2_06
#define Y_ENABLE_PIN                          AUX2_08  // (A2)
#ifndef Y_CS_PIN
  #define Y_CS_PIN                       AUX3_02
#endif
